...
// galeob:// is a display-only scheme that maps to chrome:// internally.
// When tests navigate to galeob:// URLs using
...
// that navigation observers correctly match galeob:// URLs with their chrome://
// equivalents.
