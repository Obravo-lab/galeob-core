...
const base::FilePath::CharType kBrowserProcessExecutableName[] = FPL("galeob");
const base::FilePath::CharType kHelperProcessExecutableName[] =
...
#elif BUILDFLAG(IS_ANDROID)
const base::FilePath::CharType kBrowserProcessExecutablePath[] = FPL("galeob");
const base::FilePath::CharType kHelperProcessExecutablePath[] = FPL("galeob");
#elif BUILDFLAG(IS_POSIX)
const base::FilePath::CharType kBrowserProcessExecutablePath[] = FPL("galeob");
const base::FilePath::CharType kHelperProcessExecutablePath[] = FPL("galeob");
#endif  // OS_*
