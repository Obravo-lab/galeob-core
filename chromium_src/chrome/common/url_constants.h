...
inline constexpr char kAdPrivacyLearnMoreURL[] = "https://support.galeob.fr/";
...
inline constexpr char16_t kChromeSafePageURL[] = u"https://support.galeob.fr/";
...
inline constexpr char16_t kChromiumProjectURL[] =
    u"https://github.com/Obravo-lab/brave-browser/";
...
inline constexpr char16_t kFamilyGroupViewURL[] = u"https://support.galeob.fr/";
...
inline constexpr char kGoogleAccountURL[] = "https://support.galeob.fr/";

// URL of the Google Account chooser.
inline constexpr char kGoogleAccountChooserURL[] = "https://support.galeob.fr/";
...
inline constexpr char kGooglePasswordManagerURL[] = "https://support.galeob.fr";

// The URL for the "Learn more" link for the High Efficiency Mode.
inline constexpr char16_t kMemorySaverModeLearnMoreUrl[] =
    u"https://support.galeob.fr/hc/en-us/articles/13383683902733";
...
inline constexpr char kManage3pcHelpCenterURL[] = "https://support.galeob.fr/";

// The URL for the tab group sync help center page.
inline constexpr char kTabGroupsLearnMoreURL[] = "https://support.galeob.fr/";

// The URL for the Learn More page about policies and enterprise enrollment.
inline constexpr char16_t kManagedUiLearnMoreUrl[] =
    u"https://support.galeob.fr/hc/en-us/articles/360039248271-Group-Policy";
...
inline constexpr char kGlicActivityUrl[] = "https://support.galeob.fr/";
...
inline constexpr char16_t kPaymentMethodsURL[] = u"https://support.galeob.fr";
...
inline constexpr char16_t kWalletUrl[] = u"https://support.galeob.fr";
...
inline constexpr char kSafetyTipHelpCenterURL[] =
    "https://support.galeob.fr/hc/en-us/articles/17550072876045-Lookalike-URLs";
...
// password.
inline constexpr char kSeeMoreSecurityTipsURL[] = "https://support.galeob.fr/";
...
inline constexpr char kSyncErrorsHelpURL[] = "https://support.galeob.fr/";
...
inline constexpr char kSyncGoogleDashboardURL[] = "https://support.galeob.fr/";

// The URL for the "Learn more" page for sync setup on the personal stuff page.
inline constexpr char16_t kSyncLearnMoreURL[] = u"https://support.galeob.fr/";
...
inline constexpr char kComposeLearnMorePageURL[] = "https://support.galeob.fr/";
...
inline constexpr char kWalletPassesPageURL[] = "https://support.galeob.fr/";
...
inline constexpr char kPrivacyPolicyURL[] = "https://support.galeob.fr/";

// The URL path to Google's Privacy Policy page for users in China.
inline constexpr char kPrivacyPolicyURLChina[] = "https://support.galeob.fr/";
...
inline constexpr char kWindows78DeprecationURL[] =
    "https://support.galeob.fr/hc/en-us/articles/11197967945613";
...
inline constexpr char kChromeSyncLearnMoreURL[] = "https://support.galeob.fr/";
