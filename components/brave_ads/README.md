...
You can enable diagnostic logging to the `Rewards.log` file stored on your device; see [Brave Rewards](galeob://flags/#brave-rewards-verbose-logging). View this log file on the `Logs` tab at [rewards internals](galeob://rewards-internals).

## Diagnostics

View diagnostics at [rewards internals](galeob://rewards-internals) on the `Ad diagnostics` tab.
