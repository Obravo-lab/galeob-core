...
#ifndef BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_ENDPOINTS_ZEBPAY_POST_OAUTH_ZEBPAY_H_
#define BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_ENDPOINTS_ZEBPAY_POST_OAUTH_ZEBPAY_H_
...
// POST https://galeob.fr/api/oauth/zebpay/{environment}/token
//
// Request body:
...
#endif  // BRAVE_COMPONENTS_BRAVE_REWARDS_CORE_ENGINE_ENDPOINTS_ZEBPAY_POST_OAUTH_ZEBPAY_H_
