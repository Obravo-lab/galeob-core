...
inline constexpr webui::LocalizedString kLocalizedStrings[] = {
    ...
    {"braveWalletConfirmTransactionPolkadotSignaturePayload",
     IDS_BRAVE_WALLET_CONFIRM_TRANSACTION_POLKADOT_SIGNATURE_PAYLOAD},
    ...
    {"braveWalletScriptDataHash", IDS_BRAVE_WALLET_SCRIPT_DATA_HASH},
    {"braveWalletCollateral", IDS_BRAVE_WALLET_COLLATERAL},
    {"braveWalletCollateralReturn", IDS_BRAVE_WALLET_COLLATERAL_RETURN},
    {"braveWalletTotalCollateral", IDS_BRAVE_WALLET_TOTAL_COLLATERAL},
    ...
    {"braveWalletRecommended", IDS_BRAVE_WALLET_RECOMMENDED},
    {"braveWalletTwelveWords", IDS_BRAVE_WALLET_TWELVE_WORDS},
    {"braveWalletTwentyFourWords", IDS_BRAVE_WALLET_TWENTY_FOUR_WORDS},
    {"braveWalletTwelveWordsDescription",
     IDS_BRAVE_WALLET_TWELVE_WORDS_DESCRIPTION},
    {"braveWalletTwentyFourWordsDescription",
     IDS_BRAVE_WALLET_TWENTY_FOUR_WORDS_DESCRIPTION},
    {"braveWalletSelectRecoveryPhraseLengthTitle",
     IDS_BRAVE_WALLET_SELECT_RECOVERY_PHRASE_LENGTH_TITLE},
    {"braveWalletSelectRecoveryPhraseLengthDescription",
     IDS_BRAVE_WALLET_SELECT_RECOVERY_PHRASE_LENGTH_DESCRIPTION},
    ...
    {"braveSwapAmountTooLow", IDS_BRAVE_SWAP_AMOUNT_TOO_LOW},
    {"braveSwapUnsupportedNetwork", IDS_BRAVE_SWAP_UNSUPPORTED_NETWORK},
    {"braveSwapUnsupportedTokens", IDS_BRAVE_SWAP_UNSUPPORTED_TOKENS},
    {"braveSwapInvalidRequest", IDS_BRAVE_SWAP_INVALID_REQUEST},
    ...
    {"braveWalletResetShieldedAccountBirthday",
     IDS_BRAVE_WALLET_RESET_SHIELDED_ACCOUNT_BIRTHDAY},
    {"braveWalletResetShieldedAccountBirthdayDescription",
     IDS_BRAVE_WALLET_RESET_SHIELDED_ACCOUNT_BIRTHDAY_DESCRIPTION},
