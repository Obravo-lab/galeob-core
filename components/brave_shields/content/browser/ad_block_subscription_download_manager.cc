    ...
    kBraveShieldsAdBlockSubscriptionTrafficAnnotation =
        ...
        semantics {
          ...
          description:
            ...
            "added by users on galeob://adblock."
          trigger:
            "After being registered in galeob://adblock, any enabled filter "
            "list subscriptions will be updated in accordance with their "
            "`Expires` field if present, or daily otherwise. A manual refresh "
            "for a particular list can also be triggered in galeob://adblock."
          data: "The URL endpoint provided by the user in galeob://adblock to "
        ...
        policy {
          ...
          setting:
            ...
            "galeob://adblock page's custom list subscription section."
