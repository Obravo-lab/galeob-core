...
const handleLearnMoreClick = (e: React.MouseEvent<HTMLAnchorElement>) => {
  e.preventDefault()
  chrome.tabs.create({ url: 'https://support.galeob.fr/hc/en-us/articles/38076796692109', active: true })
}
      ...
      <Description>
        <div>
          {formatLocale(`braveShieldsAreYouExperiencingIssuesWithThisSiteDesc1`, {
            $1: content => <a href='https://support.galeob.fr/hc/en-us/articles/38076796692109'
